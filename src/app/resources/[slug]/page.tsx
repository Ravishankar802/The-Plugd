...
const articleDetails: Record<string, ArticleContent> = {
  ...
  "realistic-earnings": {
    ...
    content: [
      ...
      "When we look at daily earnings, the numbers are just as solid. The top 50 promoters on the platform are earning between $140 and $250 every single day. Since you earn $1 for every direct referral who joins, this means these top users are bringing in 140 to 250 new paid members daily. They achieve this by consistently sharing their link across their primary channels—like WhatsApp groups, close Instagram communities, Discord servers, and X.",
