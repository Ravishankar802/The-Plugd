...
export default function SignupPage() {
  ...
  return (
    <main className="min-h-screen bg-white py-12 px-4 sm:px-6 font-sans selection:bg-orange-500 selection:text-black">
      <div className="w-full max-w-[460px] sm:max-w-[480px] mx-auto">
        {/* Header - directly on the page */}
        ...
        {/* Already have an account prompt - direct page flow */}
