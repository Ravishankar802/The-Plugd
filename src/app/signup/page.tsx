  ...
  const handleQrFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (result.success && result.data) {
        ...
        // Automatically populate payment link if empty or matches
        if (!paymentLink.trim()) {
      ...
      <div className="w-full max-w-[520px] mx-auto">
        ...
        <div className="rounded-2xl sm:rounded-3xl border border-zinc-200/90 bg-white p-6 sm:p-9 shadow-sm">
          ...
          <div className="text-center mb-7">
            ...
            <h1 className="mt-3.5 text-xl sm:text-2xl font-black tracking-tight text-zinc-900">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="pt-2">
              <button
                ...
                className="w-full h-12 rounded-xl bg-orange-500 font-extrabold text-sm text-black shadow-xs transition hover:bg-orange-600 hover:shadow-md active:scale-[0.99] disabled:opacity-60 flex items-center justify-center gap-2 cursor-pointer"
              >
                {loading ? (
                  <>
