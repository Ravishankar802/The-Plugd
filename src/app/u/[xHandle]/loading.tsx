      ...
      <div className="w-full max-w-5xl mx-auto px-4 md:px-8 pt-8">
          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-col md:flex-row justify-between items-start gap-6">
              <div className="flex items-center gap-6">
                {/* Avatar Skeleton */}
                <div className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-white/10 animate-pulse shrink-0" />
                
                <div className="space-y-3">
                  <div className="w-48 h-8 bg-white/10 animate-pulse rounded-lg" />
                  <div className="w-32 h-6 bg-white/10 animate-pulse rounded-md opacity-60" />
                </div>
              </div>
            ...
            <div className="space-y-2.5 max-w-3xl">
              ...
              <div className="w-5/6 h-4 bg-white/5 animate-pulse rounded" />
              <div className="w-4/6 h-4 bg-white/5 animate-pulse rounded" />
            </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-end gap-6 pt-4">
              ...
              <div className="flex items-center gap-6">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-6 bg-white/5 animate-pulse rounded" />
        ...
        <div className="w-full bg-pill border border-border rounded-2xl p-6 md:p-8 mb-12 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="space-y-2">
            ...
            <div className="w-64 h-4 bg-white/5 animate-pulse rounded" />
          </div>
          <div className="w-44 h-12 bg-white/10 animate-pulse rounded-xl" />
        </div>

        {/* Discover More Skeleton */}
        <section className="w-full mb-20">
          <div className="w-48 h-4 bg-white/5 animate-pulse rounded mb-6 opacity-40" />
            ...
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-card border border-border rounded-2xl p-6 flex flex-col gap-4">
                ...
                <div className="space-y-2 flex-1">
                  ...
                  <div className="w-4/5 h-3 bg-white/5 animate-pulse rounded" />
                </div>
