...
import type { MobileProduct } from "@/lib/mobiles-catalog";

interface MobilesCarouselSectionProps {
  id: string;
  title: string;
  subtitle: string;
  badge?: string;
...
export default function MobilesCarouselSection({
  id,
  title,
  subtitle,
  badge,
