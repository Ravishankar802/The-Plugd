      ...
      <Link href="/" className="flex items-center gap-4 mb-8 hover:opacity-80 transition-opacity group">
        <div className="relative w-10 h-10 flex items-center justify-center">
          <svg viewBox="0 0 40 40" className="w-full h-full fill-none stroke-[#ff6b00] stroke-2">
            {/* Connections */}
            <line x1="20" y1="20" x2="10" y2="10" className="signal-line" style={{ animationDuration: '3.2s', animationDelay: '0s' }} />
            <line x1="20" y1="20" x2="30" y2="10" className="signal-line" style={{ animationDuration: '2.8s', animationDelay: '0.8s' }} />
            <line x1="20" y1="20" x2="35" y2="25" className="signal-line" style={{ animationDuration: '3.5s', animationDelay: '1.6s' }} />
            <line x1="20" y1="20" x2="25" y2="35" className="signal-line" style={{ animationDuration: '2.5s', animationDelay: '0.4s' }} />
            <line x1="20" y1="20" x2="5" y2="28" className="signal-line" style={{ animationDuration: '3s', animationDelay: '2.2s' }} />
