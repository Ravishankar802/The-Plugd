  ...
  return (
    <header className="py-12 flex flex-col items-center text-center">
      <Link href="/" className="flex items-center gap-3 mb-8 hover:opacity-80 transition-opacity">
        ...
        <span className="text-2xl font-[800] tracking-[-0.02em] text-foreground">The Plugd</span>
      </Link>
      <h1 className="text-[clamp(2.5rem,6vw,4rem)] font-[800] tracking-[-0.03em] leading-[1.1] text-foreground mb-4">
