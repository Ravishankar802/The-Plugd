...
import type { BeautyProduct } from "@/lib/beauty-catalog";

interface BeautyCarouselSectionProps {
  id: string;
  title: string;
  subtitle: string;
  badge?: string;
...
export default function BeautyCarouselSection({
  id,
  title,
  subtitle,
  badge,
