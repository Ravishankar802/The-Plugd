...
import type { ElectronicsProduct } from "@/lib/electronics-catalog";

interface ElectronicsCarouselSectionProps {
  id: string;
  title: string;
  subtitle: string;
  badge?: string;
...
export default function ElectronicsCarouselSection({
  id,
  title,
  subtitle,
  badge,
  ...
  catalogDbMap = {},
  onSeeAll,
}: ElectronicsCarouselSectionProps) {
