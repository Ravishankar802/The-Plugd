    ...
    <main className="min-h-screen flex flex-col items-center w-full max-w-full overflow-x-hidden">
      ...
      <section className="w-full max-w-5xl mx-auto px-4 md:px-8 mb-10">
        <Link 
          ...
          style={{ backgroundColor: '#1a5c2a', backgroundImage: 'radial-gradient(ellipse at 15% 85%, #f59e0b 0%, transparent 45%), radial-gradient(ellipse at 85% 15%, #ca8a04 0%, transparent 45%), radial-gradient(ellipse at 75% 75%, #22c55e 0%, transparent 40%), radial-gradient(ellipse at 25% 25%, #f59e0b 0%, transparent 40%), radial-gradient(ellipse at 50% 50%, #15803d 0%, transparent 55%)' }}
        >
          <h2 
