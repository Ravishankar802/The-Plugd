  ...
  return (
    <footer className={`mt-auto py-8 ${showBorder ? "border-t border-border" : ""}`}>
      <div className="flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="flex items-center gap-6 text-[1rem] text-muted">
        ...
        {hasMounted && (
          <div className="relative" ref={dropdownRef}>
            <button
              ...
              className="flex items-center gap-2 bg-[#1c1c1c] border border-[#2a2a2a] hover:bg-[#252525] px-5 py-2.5 rounded-2xl text-[1rem] text-muted transition-colors"
            >
