...
import type { GamingProduct } from "@/lib/gaming-catalog";

interface GamingCarouselSectionProps {
  id: string;
  title: string;
  subtitle: string;
  badge?: string;
...
export default function GamingCarouselSection({
  id,
  title,
  subtitle,
  badge,
